...
class UpcomingRooms extends StatelessWidget {
  ...
  const UpcomingRooms({Key? key, required this.upcomingRooms}) : super(key: key);//this the constructor which is automatically generated
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        if(e.club.isNotEmpty) Text("${e.club} 🏠".toUpperCase(),
                        style: Theme.of(context).textTheme.overline!.copyWith(fontWeight: FontWeight.w600,letterSpacing: 1.0),),
                        Text(e.name),
                      ],
                      ),
                  ),
